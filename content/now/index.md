...
- [nlock](https://github.com/OldUser101/nlock), a Wayland screen locker that
    I may be writing specifically because I was annoyed that there was nothing
    that looked like [my favourite SDDM theme](https://github.com/stepanzubkov/where-is-my-sddm-theme).
    I aim to make this relatively customisable too, if I can implement the
    rendering properly with Cairo.

- [tars](https://github.com/OldUser101/tars), the static site generator that
    powers the website you are currently viewing. Currently working on
    implementing plugins, which should make it more extensible, with things
